package com.wing.ace.common.data_sign;
 ...
 */
    ...
    private static Data initDataTest()throws Exception{
        //要传输的明文
        List<Map<Object,Object>> list = new ArrayList<>();
        for(int i=0;i<3;i++){
            HashMap<Object, Object> signMap = new HashMap<Object, Object>();
            signMap.put("devid","920BF4CE-B9CC-449C-A146-BC5549D899ED__"+i);
            signMap.put("devtype","1_"+i);
            signMap.put("pcode","010210000_"+i);
            signMap.put("t","1472701601599_"+i);
            list.add(signMap);
        }
        Data data = new Data();
        //摘要
    ...
    private static String send(){
        String data = "";
        try{
            Data sendData = initDataTest();
            System.out.println("发送前明文数据:"+sendData.getData());
            System.out.println("发送前数字签名:"+sendData.getSignData());
